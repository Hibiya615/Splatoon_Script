...
public class Another_Merchants_Tale_B1_Echoed_Serenade_人鱼达莉娅_和声小夜曲 : SplatoonScript
{
    ...
    public override void OnSetup()
    {
        Controller.RegisterElementFromCode("seahorse",
            """{"Name":"","type":3,"refY":40.0,"radius":4.0,"color":4278190335,"fillIntensity":0.2,"thicc":3.0,"refActorDataID":19098,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("chocobo",
            """{"Name":"","type":4,"radius":45.0,"color":4278190335,"fillIntensity":0.2,"thicc":3.0,"coneAngleMin":-30,"coneAngleMax":30,"refActorDataID":19102,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("crab",
            """{"Name":"","type":3,"refY":40.0,"radius":4.0,"color":4278190335,"fillIntensity":0.2,"thicc":3.0,"refActorDataID":19100,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("puffer",
            """{"Name":"","type":4,"refY":40.0,"radius":20.0,"color":4278190335,"fillIntensity":0.2,"thicc":3.0,"coneAngleMin":-90,"coneAngleMax":90,"refActorDataID":19101,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("turtle",
            """{"Name":"","type":3,"refY":40.0,"radius":4.0,"color":4278190335,"fillIntensity":0.2,"thicc":3.0,"refActorDataID":19099,"refActorComparisonType":3,"includeRotation":true}""");

        Controller.RegisterElementFromCode("seahorsePre",
            """{"Name":"","type":3,"refY":40.0,"radius":4.0,"color":4278255615,"Filled":false,"fillIntensity":0.15,"thicc":3.0,"refActorDataID":19098,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("chocoboPre",
            """{"Name":"","type":4,"refY":40.0,"radius":45.0,"coneAngleMin":-30,"coneAngleMax":30,"color":4278255615,"Filled":false,"fillIntensity":0.15,"thicc":3.0,"refActorDataID":19102,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("crabPre",
            """{"Name":"","type":3,"refY":40.0,"radius":4.0,"color":4278255615,"Filled":false,"fillIntensity":0.15,"thicc":3.0,"refActorDataID":19100,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("pufferPre",
            """{"Name":"","type":4,"refY":40.0,"radius":20.0,"coneAngleMin":-90,"coneAngleMax":90,"color":4278255615,"Filled":false,"fillIntensity":0.15,"thicc":3.0,"refActorDataID":19101,"refActorComparisonType":3,"includeRotation":true}""");
        Controller.RegisterElementFromCode("turtlePre",
            """{"Name":"","type":3,"refY":40.0,"radius":4.0,"color":4278255615,"Filled":false,"fillIntensity":0.15,"thicc":3.0,"refActorDataID":19099,"refActorComparisonType":3,"includeRotation":true}""");
    }
