...
public class Pari_Carpet_Tracker_火仙女佩莉_搬运指示冰之辉石追踪 : SplatoonScript
{
    ...
    {
        Controller.RegisterElementFromCode("Carpet 1", """{"Name":"Carpet 1","type":3,"refY":-50.0,"offY":50.0,"radius":5.0,"color":4294967040,"fillIntensity":0.26,"thicc":0.0,"refActorDataID":19059,"refActorComparisonType":3,"includeRotation":false,"onlyVisible":true}""");
        Controller.RegisterElementFromCode("Carpet 2", """{"Name":"Carpet 2","type":3,"refX":-50.0,"offX":50.0,"radius":5.0,"color":4294967040,"fillIntensity":0.26,"thicc":0.0,"refActorDataID":19059,"refActorComparisonType":3,"includeRotation":false,"onlyVisible":true}""");
