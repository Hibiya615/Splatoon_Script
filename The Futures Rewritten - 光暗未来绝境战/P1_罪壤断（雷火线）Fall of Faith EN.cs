...
public class P1_罪壤断_雷火线_Fall_of_Faith_EN : SplatoonScript
{
    public override HashSet<uint>? ValidTerritories { get; } = [1238];
    public override Metadata? Metadata => new(2, "NightmareXIV，南雲鉄虎翻译改良");
    ...
    {
        ImGuiEx.Text($"本脚本指路为AC雷火打法（单/双排），其他打法如BD闲固请在下方禁用指路选项 \n请在下方配置队伍优先级：（一般情况下为HTD）");
        C.Priority.Draw();
    ...
    public class Config : IEzConfig
    {
        ...
        public bool EnablePositionHints = false; // 默认不启用指路
    }
}