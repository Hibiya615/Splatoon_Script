...
public unsafe class P5_光尘之剑_地火指路_Fulgent_Blade_Dodge : SplatoonScript
{
    ...
    public override void OnSetup()
    {
        for(int i = 0; i < 8; i++)
        {
            Controller.RegisterElementFromCode($"Dodge{i}", "{\"Name\":\"\",\"refX\":105.18051,\"refY\":101.17668,\"refZ\":9.536743E-07,\"color\":4278255360,\"Filled\":false,\"fillIntensity\":0.5,\"thicc\":4.0,\"overlayBGColor\":2768240640,\"overlayTextColor\":4294967295,\"overlayVOffset\":1.0,\"tether\":true,\"refActorTetherTimeMin\":0.0,\"refActorTetherTimeMax\":0.0}");
        }
        for(int i = 0; i < 8; i++)
        {
            Controller.RegisterElementFromCode($"Debug{i}", "{\"Name\":\"\",\"type\":3,\"refY\":5.0,\"radius\":0.0,\"color\":4278255360,\"fillIntensity\":0.3,\"thicc\":4.0,\"overlayBGColor\":2768240640,\"overlayTextColor\":4294967295,\"overlayVOffset\":1.0,\"refActorComparisonType\":2,\"includeRotation\":true,\"refActorTetherTimeMin\":0.0,\"refActorTetherTimeMax\":0.0}");
        }
